...
const RawDenimHeirloomManBraid = () => {
  return (
    <section className="text-gray-400 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="text-center mb-20">
          <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-sky-400 mb-4">Raw Denim Heirloom Man Braid</h1>
...
export default RawDenimHeirloomManBraid;